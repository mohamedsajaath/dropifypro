...
function initDataTable(
    ...
    let dt_options = {
        ...
        fnDrawCallback: function () {
            ...
            resetButton(
                $("#filter-form").find("button[type=submit]"),
                "Submit"
            );
        },
...
$(document).on("change", ".select-dynamic", function () {
    ...
    $.ajax({
        ...
        dataType: "json",
        success: function (data) {
            if (data.result == "error") notify(data.message, data.result);
...
$(document).on("click", "#download-file", function (e) {
    ...
    $.ajax({
        ...
        dataType: "json",
        success: function (data) {
            if (data.status == "success") window.open(data.path, "_blank");
            else notify(data.message, data.status);
        },
    });
});
