<tr>
    <td>
        <div class="d-flex align-items-center">
            ...
            <div class="ms-5">
                <!--begin::Title-->
                <a
                    class="text-gray-800 text-hover-primary fs-5 fw-bold product-slider"
                    data-kt-ecommerce-product-filter="product_name">
                    Smart Watch GT-1102</a>
                <span class="text-gray-400 fw-semibold d-block fs-7">$52.23</span>
                <!--end::Title-->
            </div>
        </div>
    </td>
    ...
    <td class="text-end pe-0">
        <span class="fw-bold">E02882009</span>
    </td>
    <!--end::SKU=-->
    <!--begin::Qty=-->
    <td class="text-end pe-0">
    ...
    <td class="text-end pe-0 text-center" data-order="Scheduled" >
        <!--begin::Badges-->
        <span class="fw-bold ms-3" data-bs-toggle="tooltip" data-bs-placement="Bottom" title="Reccommended"><span class="badge badge-circle badge-success h-15px w-15px"></span></span>
        <!--end::Badges-->
    </td>
    <!--end::Status=-->
    <!--begin::Action=-->
...
<tr>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="ms-5">
                ...
                <a
                    ...
                    data-kt-ecommerce-product-filter="product_name">
                    Ear Buds k-32</a>
                <span class="text-gray-400 fw-semibold d-block fs-7">$25.23</span>
                <!--end::Title-->
            </div>
        </div>
    </td>
    ...
    <!--begin::SKU=-->
    <td class="text-end pe-0">
        <span class="fw-bold">E02883009</span>
    </td>
    <!--end::SKU=-->
    <!--begin::Qty=-->
    <td class="text-end pe-0">
        <span class="fw-bold ms-3">56</span>
    </td>
    <!--end::Qty=-->
...
<tr>
    ...
    <td class="text-end pe-0 text-center" data-order="Scheduled">
        <!--begin::Badges-->
        <span class="fw-bold ms-3" data-bs-toggle="tooltip" data-bs-placement="Bottom" title="Not Reccommended"><span class="badge badge-circle badge-danger h-15px w-15px"></span></span>
        <!--end::Badges-->
    </td>
    <!--end::Status=-->
    <!--begin::Action=-->
    <td class="text-end ">
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" data-kt-menu="true">
            ...
            <!--begin::Menu item-->
            <div class="menu-item px-3">
                <a  class="menu-link px-3 d-flex gap-5"><i class="bi bi-person-check-fill"></i> Recommend</a>
            </div>
            <!--end::Menu item-->
        </div>
        <!--end::Menu-->
...
<tr>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="ms-5">
                ...
                <a
                    ...
                    data-kt-ecommerce-product-filter="product_name">
                    Grape Syrup</a>
                <span class="text-gray-400 fw-semibold d-block fs-7">$15.23</span>
                <!--end::Title-->
            </div>
        </div>
    </td>
    ...
    <!--begin::SKU=-->
    <td class="text-end pe-0">
        <span class="fw-bold">F02882009</span>
    </td>
    <!--end::SKU=-->
    <!--begin::Qty=-->
    <td class="text-end pe-0">
    ...
    <td>
        <div class="d-flex align-items-center">
            ...
            <div class="ms-5">
                <!--begin::Title-->
                <a
                    class="text-gray-800 text-hover-primary fs-5 fw-bold product-slider seller-slider"
                    data-kt-ecommerce-product-filter="product_name">
                    Smart Watch GT-1102</a>
                <span class="text-gray-400 fw-semibold d-block fs-7">$52.23</span>
                <!--end::Title-->
