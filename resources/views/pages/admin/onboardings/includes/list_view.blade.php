        ...
        <div class="card h-md-100">
            ...
            <div class="card-header border-0 pt-5">
                ...
                <span class="card-title align-items-end flex-column">
                    <button class="btn btn-flex btn-primary" id="add-onboarding">
                        Add Event
                    </button>
                </span>
            </div>
            ...
            <div class="card-body pt-7 px-0">
                ...
                <div class="tab-content  mb-2 px-9" id="onboarding-content">
                    ...
                    @foreach ($onboarding as $onboarding_result)
                        <div class="tab-pane fade show active content-wrapper" role="tabpanel"
                            ...
                            <div class="d-flex align-items-center mb-6">
                                ...
                                <div class="flex-grow-1 me-5">
                                    ...
                                    <div class="text-gray-800 fw-semibold fs-2">
                                        ...
                                        <span
                                            class="text-gray-400 fw-semibold fs-7">{{ $onboarding_result['start_time'] }}-{{ $onboarding_result['end_time'] }}</span>
                                    </div>
                                    <!--end::Time-->
                                    <!--begin::Description-->
                                    ...
                                    @if ($onboarding_result['user_id'] != '')
                                        <div class="text-gray-400 fw-semibold fs-7">Seller Id
                                            <!--begin::Name-->
                                            <a href="#"
                                                class="text-primary opacity-75-hover fw-semibold">{{ $onboarding_result['user_id'] }}</a>
                                            <!--end::Name-->
                                        </div>
                                    @endif
                                    <!--end::Link-->
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item edit_event" href="#"
                                            data-id="{{ $onboarding_result['id'] }}">Edit</a>
                                        <a class="dropdown-item delete-onboarding" href="#"
                                            data-id="{{ $onboarding_result['id'] }}">Delete</a>
                                    </div>
                                </div>
                            </div>
                            <!--end::Wrapper-->
