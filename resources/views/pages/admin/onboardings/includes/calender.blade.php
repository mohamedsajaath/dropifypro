<div id="kt_app_content" class="app-content flex-column-fluid calender-content">
    <!--begin::Content container-->
    <div id="kt_app_content_container" class="app-container container-xxl m-0 max-width-100vw">
        <!--begin::Card-->
        <div class="card">
            <!--begin::Card header-->
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <button class="btn btn-flex bc-blue" data-kt-calendar="add">
                        Add Event
                    </button>
            ...
            <div class="card-body">
                ...
                <div id="kt_calendar_app" class="fc fc-media-screen fc-direction-ltr fc-theme-standard">
                    <div class="fc-header-toolbar fc-toolbar fc-toolbar-ltr">
                        ...
                        <div class="fc-toolbar-chunk"><h2 class="fc-toolbar-title" id="fc-dom-1">November
                                2022</h2></div>
                        <div class="fc-toolbar-chunk">
                            <div class="fc-button-group">
                                            ...
                                            <div class="fc-scroller fc-scroller-liquid-absolute"
                                                ...
                                                <div class="fc-daygrid-body fc-daygrid-body-balanced "
                                                    ...
                                                    <table role="presentation" class="fc-scrollgrid-sync-table"
                                                           style="width: 916px; height: 632px;">
                                                        <colgroup></colgroup>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="fc-daygrid-day-events">
                                                                        <div
                                                                            class="fc-daygrid-event-harness fc-daygrid-event-harness-abs"
                                                                            style="top: 0px; left: 0px; right: -130.844px;">
                                                                            <a class="fc-daygrid-event fc-daygrid-block-event fc-h-event fc-event fc-event-draggable fc-event-resizable fc-event-start fc-event-end fc-event-primary"
                                                                               tabindex="0">
                                                                                <div class="fc-event-main">
                                                                                    <div
                                                                                        class="fc-event-main-frame">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="fc-daygrid-day-events">
                                                                        ...
                                                                        <div
                                                                            class="fc-daygrid-event-harness fc-daygrid-event-harness-abs"
                                                                            style="visibility: hidden; top: 0px; left: 0px; right: 0px;">
                                                                            <a class="fc-daygrid-event fc-daygrid-dot-event fc-event fc-event-draggable fc-event-resizable fc-event-start fc-event-end fc-event-today fc-event-danger"
                                                                               tabindex="0">
                                                                                <div
                                                                                    class="fc-daygrid-event-dot"></div>
