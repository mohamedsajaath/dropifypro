    ...
    <div class="row  mb-5 mb-xl-10 pl-2 pr-2" style="padding: 0 2rem;">
        <div class="card mb-xl-6 ">
            ...
            <div class="card-header p-20 border-20 justify-content-center" style="border: black;">
                ...
                <form id="kt_modal_new_card_form" class="form fv-plugins-bootstrap5 fv-plugins-framework w-50"
                    ...
                    <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                        ...
                        <label class="d-flex align-items-center fs-6 fw-semibold form-label mb-2">
                            ...
                            <i data-bs-toggle="tooltip" aria-label="Specify a card holder's name"
                                data-kt-initialized="1"></i>
                        </label>
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" placeholder="Product ID"
                    ...
                    <div class="text-center pt-15">
                        <button type="reset" id="kt_modal_new_card_cancel"
                            class="btn btn-light btn-sm me-3">Reset</button>
