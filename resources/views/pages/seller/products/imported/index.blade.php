                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-end min-w-100px sorting" tabindex="0"
                                    aria-controls="kt_ecommerce_products_table" rowspan="1" colspan="1"
                                    aria-label="Rating: activate to sort column ascending" style="width: 140.875px;">Dispach
                                    Time
                                </th>
                                <th class="text-end min-w-100px sorting" tabindex="0"
                                    aria-controls="kt_ecommerce_products_table" rowspan="1" colspan="1"
                                    aria-label="Rating: activate to sort column ascending" style="width: 140.875px;">
                                    Delivery Time
                                </th>
                            </tr>
                            <!--end::Table row-->
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            ...
                            @include('pages.seller.products.imported.includes.product-table-rows')
...
`);
    ...
    <script>
        loadBreadCrumbWithHeader("Products", "Imported", "Dashboard", "#")
    </script>
@endpush
