                        ...
                        <div class="border rounded p-4">
                            <nav>
                                <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                                    <button class="nav-link fw-semi-bold active" id="nav-story-tab"
                                        ...
                                        role="tab" aria-controls="nav-story" aria-selected="true">
                                        Story
                                    </button>
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade" id="nav-mission" role="tabpanel"
                                    ...
                                    <p>
                                        Your store is full of products that <b>fail to sell</b> or <b>don’t make any
                                            profit </b>.
                                    </p>
                                </div>
                                    ...
                                    <div class="row g-4">
                                        <div class="col-12 wow fadeIn" data-wow-delay="0.3s">
                                            <div class="feature-box border rounded p-4">
                                                ...
                                                <p class="mb-3">
                                                    It helps you build and maintain Mission, and Vision, growth and
                                                    power.
                                                </p>
                                            </div>
                                        </div>
                ...
                <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.3s">
                    <div class="testimonial-item">
                        <div class="testimonial-text border rounded p-4 pt-5 mb-5" style="height: 350px;">
                            ...
                            With DropifyPro, I receive not only the the-best tool made from drop shippers to drop
                            shippers.
                            I
                            receive support, community, and training that I always recommend to my students. To boost
                            your
                            sales, I
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-text border rounded p-4 pt-5 mb-5" style="height: 350px;">
                            ...
                            As a user for 6 months now; it is the best investment I have made for my dropshipping
                            business
                            to be
                            successful. Massive advantage over the competition and other sellers with the various
                            built-in
                            tools.
                            Constantly coming out with new releases and other tools to help your business grow, they are
                            a
                            clear winner
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-text border rounded p-4 pt-5 mb-5" style="height: 350px;">
                            ...
                            DropifyPro is easy to use, the data is very accurate and the customer service always helpful
                            You
                            can find
                            all the information I need about product research and eBay selling inside DropifyPro as well
                            to
                            the greate features they have mainly product and competitor research And for the titles I
                            have
                            the unique
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-text border rounded p-4 pt-5 mb-5" style="height: 350px;">
                            ...
                            Very helpful program and group of people. YouTube channel has tons of vids and more out
                            weekly.
                            Fb group is
