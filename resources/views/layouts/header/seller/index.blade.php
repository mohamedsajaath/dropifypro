...
<div class="app-navbar flex-shrink-0">
    ...
    <div class="app-navbar-item ms-1 ms-lg-3">
        <!--begin::Menu toggle-->
        <a href="{{ route('seller.ebay') }}"
           class="btn btn-custom btn-icon-muted btn-active-light btn-active-color-primary  p-5 fs-6">
          <span style="color:#E53238;">e</span><span style="color:#0064D2;">b</span><span style="color:#F5AF02;">a</span><span style="color:#86B817;">y</span><br/>
    ...
    <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
            ...
            <div class="menu-item px-5">
                <a href="{{ route('seller.overview') }}" class="menu-link px-5">My Profile</a>
            </div>
            <!--end::Menu item-->
            <!--begin::Menu item-->
            <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                ...
                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                    ...
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="" class="menu-link px-5">Upgrade</a>
                    </div>
                    <!--end::Menu item-->
                </div>
                <!--end::Menu sub-->
            ...
            <div class="menu-item px-5 my-1">
                <a href="{{ route('seller.overview') }}" class="menu-link px-5">Account Settings</a>
            </div>
            <!--end::Menu item-->
            <!--begin::Menu item-->
            <div class="menu-item px-5">
